...
var smoothBeta={}, smoothAlpha={}, smoothGamma={}, smoothSample = 3;
...
THREE.DeviceControls = function ( camera ) {
	...
	// SMOOTH!
	smoothBeta.sampleNumber = smoothSample;
	smoothBeta.index = 0;
	smoothBeta.total = 0;
	...
	smoothGamma.sampleNumber = smoothSample;
	smoothGamma.index = 0;
	smoothGamma.total = 0;
	...
	smoothAlpha.sampleNumber = smoothSample;
	smoothAlpha.index = 0;
	smoothAlpha.total = 0;
	...
	this.update = function ( delta ) {
		...
		if ( moveForward || deviceMoveForward ) {
			velocity.z -= this.moveSpeed * delta;
			// console.log("moveForward");
		}

		if ( moveBackward || deviceMoveBackward ) {
			velocity.z += this.moveSpeed * delta;
			// console.log("moveBackward");
		}
