...
THREE.DeviceControls = function ( camera ) {
 ...
 // 	}
	...
	this.update = function ( delta ) {
		...
		if ( moveForward ) velocity.z -= this.moveSpeed;
		if ( moveBackward ) velocity.z += this.moveSpeed;
		...
		if( thisIsTouchDevice ) {
			...
			// rotate camera
	 		...
	 		var tmpQ_head = eyeFinalQ.clone();
			tmpQ_head.normalize();
			headDetectObj.rotation.setFromQuaternion( tmpQ_head );
