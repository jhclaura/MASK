...
THREE.DeviceControls = function ( camera ) {
	...
	this.update = function ( delta ) {
		...
		// console.log( "acceleX: " + formatFloat(this.acceleX, 1) + ", acceleY: " + formatFloat(this.acceleY, 1) + ", acceleZ: " + formatFloat(this.acceleZ, 1) );
		// if( Math.abs(this.acceleX) > 1)
		// 	console.log( "acceleX: " + formatFloat(this.acceleX, 1) );

		// if( Math.abs(this.acceleY) > 0.2)
		// 	console.log( "acceleY: " + formatFloat(this.acceleY, 1) );

		// if( Math.abs(this.acceleZ) > 0.2)
		// 	console.log( "acceleZ: " + formatFloat(this.acceleZ, 1) );
		...
		// if ( this.acceleX > 0.5)		{ deviceMoveRight = true; console.log("deviceMoveRight"); }
		// else 							deviceMoveRight = false;
		// if ( this.acceleZ < -0.5 )		{ deviceMoveLeft = true; console.log("deviceMoveLeft"); }
		// else 							deviceMoveLeft = false;

		// SMOOTH!
			// smoothAlpha += (this.alpha - smoothAlpha) / smoothAmount;
			// smoothBeta += (this.beta - smoothBeta) / smoothAmount;
			// smoothGamma += (this.gamma - smoothGamma) / smoothAmount;
			// var aTmp = smooth( smoothAlpha, alphaRecordings, this.alpha );
			// var bTmp = smooth( smoothAlpha, alphaRecordings, this.beta );
			// var gTmp = smooth( smoothAlpha, alphaRecordings, this.gamma );

			// console.log("aTmp: " + aTmp + ", bTmp: " + bTmp + ", gTmp: " + gTmp);
