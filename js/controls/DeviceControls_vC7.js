...
THREE.DeviceControls = function ( camera ) {
	...
	this.update = function ( delta ) {
		...
		*/
		...
		// yawObject.position.y = 1;
		if(onObject == true) {
			yawObject.position.y = myStartY-distance;
		}
		...
		////////
		//if you're the 1st in House, your camera will control the third
			if(whoIamInMask==1){
				var msg = {
					'type': 'updatePlayer',
					'index': whoIamInMask,
		...
		//if you're the third in House, your camera will be controlved by the first
			// if(whoIamInMask==3){
			// 	yawObject.rotation.setFromQuaternion( eyeFinalQ );
			// }
