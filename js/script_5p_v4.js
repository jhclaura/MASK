...
var myPosY;
var myStartX = 0, myStartZ = 0, myStartY = 30;		//myStartY = 2
var worldCenter;
...
// Guysss
	...
	var connections = [], connectMat, fadeConnections = [];
...
// touches
	...
	var horse, resetHorse = false, horseWalking = false, durationH = 1200, keyframeH = 39;
...
function update(){	
	...
	danceStep += 1.898;	//3.75, 2.945, 2.618, 2.4216, 1.898
