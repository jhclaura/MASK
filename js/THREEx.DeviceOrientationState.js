...
{
	this._state.x	= (!event.alpha ? 0 : event.alpha) ;
	this._state.y	= (!event.beta  ? 0 : event.beta ) ;
	this._state.z	= (!event.gamma ? 0 : event.gamma) ;
}
...
THREEx.DeviceOrientationState.prototype.beta	= function()
{
	return this._state.y;
}

THREEx.DeviceOrientationState.prototype.gamma	= function()
{
