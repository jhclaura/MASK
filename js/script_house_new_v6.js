...
function superInit()
{
	...
	// 	} );
	// }
	var h_tex_loader = new THREE.TextureLoader();
	h_tex_loader.load('images/roomTexture.png', function(texture){
	...
	// LAMP
		...
		//v.2
		var w_tex_Loader = new THREE.TextureLoader();
		w_tex_Loader.load( 'images/wood.png', function(texture){
			woodTexture = texture;

			var g_tex_Loader = new THREE.TextureLoader();
			g_tex_Loader.load( 'images/glow_edit.png', function(textureB){
	...
	// GUY
		//v.2
		var guy_tex_Loader = new THREE.TextureLoader();
		guy_tex_Loader.load('images/guyAni.png', function(texture){
			guyTexture = texture;
