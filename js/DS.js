...
function DS(x,y,z,texture){
    ...
    this.pointL = new THREE.PointLight( 0x30e3d2, 0.5, lightDis );
	...
	this.glowMat = new THREE.SpriteMaterial(
	      {
	        map: this.texture,
	        color: 0x30e3d2, transparent: false, blending: THREE.AdditiveBlending
	      });
	this.glow = new THREE.Sprite(this.glowMat);
	this.glow.scale.set(1,1,1);	//big
...
/*
DS.prototype.flock = function(lightbulbs) {
...
DS.prototype.applyForce = function(force){
	this.acceleration.add(force);
}

DS.prototype.borders = function(spaceLimit, floor){
...
DS.prototype.separate = function(lightbulbs) {
...
DS.prototype.separateSingle = function(lightbulbPos) {

	//var desiredseparation = this.r*80;
	var desiredseparation = this.r*100;
	var sum = new THREE.Vector3();
	var count = 0;
...
DS.prototype.separateFromFloor = function(floor) {
...
DS.prototype.seek = function(target){
...
DS.prototype.returnSeek = function(target){
	var desired = new THREE.Vector3();
...
DS.prototype.arrive = function(target){
	var desired = new THREE.Vector3();
	// target --> Vector3
	desired.subVectors(target, this.position);
...
DS.prototype.align = function(lightbulbs){
...
DS.prototype.cohesion = function(lightbulbs) {
...
DS.prototype.setArriveScalar = function(strength) {
	this.arriveScalar = strength;
}

DS.prototype.setSeparateSingleScalar = function(strength) {
