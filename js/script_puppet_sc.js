...
// computer vision
	...
	var seeFaceTime, noFaceTime, enterConversationTime, faceDuration = 1000, conversationDuration = 2000;
	var conIndex = 0;
...
function draw_faces(ctx, rects, sc, max) {
    ...
    n = Math.min(n, on);
    	...
    	// AUDIO!!
	    	...
	    	if( (noFaceTime+conversationDuration < Date.now()) && !seeFace && !reallyNoFace){
	    		reallyNoFace = true;
	    		reallySeeFace = false;
	    		enterConversation = false;
	    		conIndex = 0;
