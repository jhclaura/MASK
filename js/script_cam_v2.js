...
{	
	...
	// CAM
		...
		var tvGeo = new THREE.PlaneGeometry(32, 24, 1, 1);
		transZ(tvGeo, myStartZ-60);
		...
		eye = new THREE.Mesh(tvGeo, tvMat);
...
{	
	...
	// camRotDeg.set( camRot.x * 180/Math.PI, camRot.y * 180/Math.PI, camRot.z * 180/Math.PI );
	// console.log( "camRot.x: " + camRotDeg.x + ", camRot.y: " + camRotDeg.y + ", camRot.z: " + camRotDeg.z );
	...
	// eye.position.set( camPos.x - 50*Math.sin( camRot.y ), 0 - 50*Math.sin( -camRot.x ), camPos.z + 50*Math.cos( camRot.y ) );
